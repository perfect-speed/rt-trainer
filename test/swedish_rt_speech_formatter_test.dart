...
void main() {
  ...
  test('formats full callsign runway QNH and transponder deterministically', () {
    expect(
      ...
      'Sigurd Erik Kalle Qvintus Xerxes, bana nolla ett, ku enn Helge ett nolla ett sexa, transponder fyra tvåa femma femma.',
    );
  });
  ...
  test('formats runway 19 and QNH 1009 using clarified Swedish digit words', () {
    expect(
      ...
      'Sigurd Erik Viktor Petter Tore, bana ett nia, ku enn Helge ett nolla nolla nia.',
    );
  });
  ...
  test('never leaves literal QNH for generic TTS pronunciation', () {
    expect(formatter.format('QNH'), 'ku enn Helge');
  });
}
